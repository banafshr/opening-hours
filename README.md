...
You can either build this project in `docker` or on your local machine
...
The frontend is accessible from `localhost:3000`
Backend runs on `localhost:3001`
...
To run tests unit tests & e2e test: in `/frontend`:
